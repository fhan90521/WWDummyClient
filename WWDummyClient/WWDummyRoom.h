...
private:
	...
	int _deleteNoneExistCharacter = 0;
...
public:
	...
	void SendChatMessageSC(SessionInfo sessionInfo, short mapID);
	void MoveMyCharacterSC(SessionInfo sessionInfo, short mapID); 
	void MoveOtherCharacterSC(SessionInfo sessionInfo, short mapID);
